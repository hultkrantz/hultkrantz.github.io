...
class AddGame extends React.Component {
    render(){
        ...
        const arr =['title', 'description', 'year', 'system'],
         inputs = arr.map((input, i)=>{return <input styling={this.props.style} key={'input' + i} name={input} onChange={this.props.handleChange} onLoad={valueDisplayer(input, this.props.data)} value={myValue} placeholder={input} type="text" />});
        return(
            <div>
                {inputs}
